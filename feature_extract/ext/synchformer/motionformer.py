...
class MotionFormer(VisionTransformer):
    ...
    def __init__(
        ...
        # pyre-fixme[9]: ckpt_path has type `str`; used as `None`.
        ckpt_path: str = None,
        # pyre-fixme[9]: factorize_space_time has type `bool`; used as `None`.
        factorize_space_time: bool = None,
        # pyre-fixme[9]: agg_space_module has type `str`; used as `None`.
        agg_space_module: str = None,
        # pyre-fixme[9]: agg_time_module has type `str`; used as `None`.
        agg_time_module: str = None,
        add_global_repr: bool = True,
        # pyre-fixme[9]: agg_segments_module has type `str`; used as `None`.
        agg_segments_module: str = None,
        # pyre-fixme[9]: max_segments has type `int`; used as `None`.
        ...
        # pyre-fixme[61]: `pos_emb_type` is undefined, or not always defined.
        ...
        if (self.ckpt_path is not None) and (not was_pt_on_avclip):
            # pyre-fixme[61]: `ckpt` is undefined, or not always defined.
...
class BaseEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def __init__(
        ...
        # pyre-fixme[9]: pos_emb_drop has type `float`; used as `None`.
        pos_emb_drop: float = None,
        # pyre-fixme[9]: pos_max_len has type `int`; used as `None`.
    ...
    #  `TransformerEncoderLayer` inconsistently.
    # pyre-fixme[9]: x_mask has type `Tensor`; used as `None`.
...
class AveragePooling(nn.Module):
    # pyre-fixme[9]: then_permute_pattern has type `str`; used as `None`.
